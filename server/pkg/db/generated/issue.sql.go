...
INSERT INTO issue (
    ...
    $15, $16
) RETURNING id, workspace_id, title, description, status, priority, assignee_type, assignee_id, creator_type, creator_id, parent_issue_id, acceptance_criteria, context_refs, position, due_date, created_at, updated_at, number, project_id, origin_type, origin_id, first_executed_at, captain_type, captain_id
`
...
type CreateIssueParams struct {
	...
	ProjectID     pgtype.UUID        `json:"project_id"`
	CaptainType   pgtype.Text        `json:"captain_type"`
...
SELECT id, workspace_id, title, description, status, priority, assignee_type, assignee_id, creator_type, creator_id, parent_issue_id, acceptance_criteria, context_refs, position, due_date, created_at, updated_at, number, project_id, origin_type, origin_id, first_executed_at, captain_type, captain_id FROM issue
WHERE id = $1
`
