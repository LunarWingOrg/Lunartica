          ...
          <div className="lg:w-[480px] lg:shrink-0">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Link
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center gap-2.5 rounded-[12px] bg-[#2563eb] px-5 py-3 text-[14px] font-semibold text-white transition-colors hover:bg-[#1d4ed8]"
              >
